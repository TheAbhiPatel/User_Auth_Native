...
const sendEmail = async (
  ...
  try {
    ...
    ${isVerification ? "" : "There was a request to change your password."}
      ...
      isVerification
        ? "Thanks for creating a account on ChatAPP. Please verify your email address by entering the verification code given below. This opt will expires in 15 minutes."
        : "Forget your password by entering the verification code given below."
    }</p></div><div class="MuiGrid-root MuiGrid-item mui-style-we1pe7-MuiGrid-root" style="box-sizing: border-box; flex-direction: row; display: flex; -webkit-box-pack: center; justify-content: center; -webkit-box-align: center; align-items: center; width: 638.5px; margin: 10px;"><button class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium mui-style-5ku08p-MuiButtonBase-root-MuiIconButton-root" tabindex="0"  style="box-sizing: border-box; -webkit-box-align: center; align-items: center; -webkit-box-pack: center; justify-content: center; position: relative; -webkit-tap-highlight-color: transparent; outline: 0px; border: 0px; margin: 0px 0px 3px; cursor: text;  vertical-align: middle;  text-decoration: none; text-align: center; flex: 0 0 auto; padding: 8px; overflow: visible; transition: background-color 150ms cubic-bezier(0.4, 0, 0.2, 1) 0ms; display: inline-flex; height: 35px; font-size: 18px; border-radius: 5px; color: white; background-color: #007bff; width: 191.547px;">
    ${token}
     <span class="MuiTouchRipple-root mui-style-8je8zh-MuiTouchRipple-root" style="box-sizing: inherit; overflow: hidden; pointer-events: none; position: absolute; z-index: 0; inset: 0px; border-radius: inherit;"></span></button></div><p class="MuiTypography-root MuiTypography-body2 mui-style-luykof-MuiTypography-root" style="box-sizing: inherit; margin: 0px; font-size: 18px; font-weight: 400; font-family: &quot;PT Sans&quot;; line-height: 1.43; padding-left: 10px;">Thank You,</p><p class="MuiTypography-root MuiTypography-body2 mui-style-luykof-MuiTypography-root" style="box-sizing: inherit; margin: 0px; font-size: 18px; font-weight: 400; font-family: &quot;PT Sans&quot;; line-height: 1.43; padding-left: 10px;">ChatAPP</p></div> `;
